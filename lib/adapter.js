...
var Adapter = exports.Adapter = function () {
  ...
  _createClass(Adapter, [{
    ...
    key: 'update',
    value: function () {
      var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(type, keyData, data) {
        var _this4 = this;
    ...
    key: 'destroy',
    value: function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(type, keyData) {
        var _this5 = this;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                return _context5.abrupt('return', new Promise(function (resolve, reject) {
                  ...
                  try {
                    key = _this5.datastore.key(keyData.path);
                  } catch (err) {
                    return reject(err);
                  }
    ...
    key: 'destroyMany',
    value: function () {
      var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(type, args) {
        var _this6 = this;
                ...
                return _context6.abrupt('return', new Promise(function (resolve, reject) {
                  ...
                  try {
                    readArgs.forEach(function (ra) {
                      ...
                      if (_.isArray(ra)) {
                        key = _this6.datastore.key(ra);
                      } else {
                        key = _this6.datastore.key([type, ra]);
                      }
                      keys.push(key);
                    });
                  } catch (err) {
      ...
      function destroyMany(_x14, _x15) {
